...
RoomSelectionController.$inject = ['$scope', '$state', '$log', '$ionicHistory', 'Chats', 'ApiService', 'AuthService', 'localStorageService', 'ChatEndPoint'];
function RoomSelectionController($scope, $state, $log, $ionicHistory, Chats, ApiService, AuthService, localStorageService, ChatEndPoint) {
